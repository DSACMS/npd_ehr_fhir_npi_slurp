...
class PostgreSQLTableManager:
    ...
    def __init__(self):
        ...
        self.tables = {
            ...
            'endpoint_instance_to_other_id': pd.DataFrame(columns=['endpoint_instance_id', 'other_id', 'system', 'issuer_id', 'is_valid_format', 'is_valid_api', 'validation_error']),
            'endpoint_instance_to_payload': pd.DataFrame(columns=['endpoint_instance_id', 'payload_type_id', 'mime_type_id']),
